        ...
        <div className="shrink-0 mt-3">
          <div className="flex gap-2 items-end">
            <textarea
              ...
              rows={3}
              className="flex-1 bg-white/8 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 resize-none focus:outline-none focus:border-blue-500/50 disabled:opacity-50"
            />
            <button
